...
const brandMarks = [
  { position: "left-5 top-8", size: "h-14 w-14", delay: 0.2 },
  { position: "right-8 bottom-10", size: "h-20 w-20", delay: 0.35 },
];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(246,195,67,0.18),transparent_40%),radial-gradient(circle_at_80%_30%,rgba(56,189,248,0.12),transparent_42%),radial-gradient(circle_at_12%_82%,rgba(255,231,163,0.12),transparent_40%)]"
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-12 text-center">
        <motion.div
          className="mb-10 flex items-center gap-4 rounded-full border border-brand-gold/40 bg-white/10 px-6 py-3 shadow-lg shadow-amber-400/25 backdrop-blur"
